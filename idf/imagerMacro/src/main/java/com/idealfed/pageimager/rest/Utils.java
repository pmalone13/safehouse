...
public class Utils {
  ...
  private final SpaceManager spaceManager;
    ...
    @Inject
    public Utils(PluginSettingsFactory pluginSettingsFactory, PageManager pageManager, SpaceManager spaceManager, ApplicationLinkService applicationLinkService)
    {
	...
	{
  	   log.error("DEBUG: processing the copypage");
	   ...
	   if(sourcePageId!=null)
	   {
          ...
          if(targetPageId.equals("initialize"))
	      {
			  ...
			  //must create a new page under acroPage
  			  Page page = new Page();
 			  page.setTitle(sPage.getTitle()+ " (PSR)");
	      ...
	      else
	      {
			  ...
			  String sPageString = StructureUtils.getStructure(sPage.getBodyAsString(),this.applicationLinkService);

			  //log.error(sPageString);

			  tPage.setBodyAsString(sPageString);
			  tPage.setVersionComment("From Imager Rest");
